package haveric.recipeManager.common;
...
public enum RMCChatColor {
    ...
    private static final Map<Character, RMCChatColor> BY_CHAR = new HashMap<>();
     ...
     * @return Associative {@link RMCChatColor} with the given code,
