...
public class ToolsRecipeV1_12 {
    public static boolean matchesFurnace(Recipe bukkitRecipe, org.bukkit.inventory.ItemStack furnaceIngredient) {
    ...
    public static boolean matchesShaped(Recipe bukkitRecipe, org.bukkit.inventory.ItemStack[] ingredients, int width, int height) {
    ...
    public static boolean matchesShapeless(Recipe bukkitRecipe, List<org.bukkit.inventory.ItemStack> ingredients) {
        if (bukkitRecipe instanceof CraftShapelessRecipe) {
            ...
            if (ingredients.size() != shapelessRecipe.getIngredientList().size()) {
                return false;
            }
            ...
            try {
                ...
                // from Bukkit / spigot...
                for (org.bukkit.inventory.ItemStack baseItem : ingredients) {
                    boolean match = false;
