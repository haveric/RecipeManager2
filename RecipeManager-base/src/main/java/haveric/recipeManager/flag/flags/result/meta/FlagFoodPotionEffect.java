    ...
    public void parseItemMeta(ItemStack item, ItemMeta meta, StringBuilder recipeString) {
        if (meta != null && meta.hasFood()) {
            ...
            for (FoodComponent.FoodEffect effect : food.getEffects()) {
                recipeString.append(Files.NL).append("@foodpotioneffect ").append(effect.getProbability()).append(" | ");
                ToolsFlag.parsePotionEffectForItemMeta(recipeString, effect.getEffect());
            }
        }
    }
}
