...
public class FlagIngredientCondition extends Flag {
    ...
    protected String[] getDescription() {
        String[] description = new String[]{
            ...
            "",
            "  nometa or !meta",
            "    Ingredient must have no metadata (enchants, bookenchants, name, itemname, lore, color, unbreakable, hidetooltip, enchantmentglint, fireresistant, localizedname, custommodeldata)",
            "    Overrides enchant, name, itemname, lore, color, unbreakable, hidetooltip, enchantmentglint, fireresistant, localizedname, custommodeldata conditions if set",
            "    Equivalent to noenchant | nobookenchant | noname | noitemname | nolore | nocolor | nounbreakable | nohidetooltip | noenchantmentglint | nofireresistant | nolocalizedname | nocustommodeldata",
            "",
            "  needed <num>",
