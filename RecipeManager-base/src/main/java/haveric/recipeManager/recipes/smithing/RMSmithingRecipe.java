...
public class RMSmithingRecipe extends PreparableResultRecipe {
    ...
    public SmithingRecipe toBukkitRecipe(boolean vanilla) {
        ...
        if (vanilla) {
            bukkitRecipe = new SmithingRecipe(getNamespacedKey(), getFirstResultItemStack(), getPrimaryIngredientChoice(), getSecondaryIngredientChoice());
        } else {
            ...
            bukkitRecipe = new SmithingRecipe(getNamespacedKey(), a.result().getItemStack(), getPrimaryIngredientChoice(), getSecondaryIngredientChoice());
        }
