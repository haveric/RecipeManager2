...
public class RMSmithing1_19_4TransformRecipe extends RMSmithingRecipe {
    ...
    public SmithingTransformRecipe toBukkitRecipe(boolean vanilla) {
        ...
        if (vanilla) {
            bukkitRecipe = new SmithingTransformRecipe(getNamespacedKey(), getFirstResultItemStack(), getTemplateIngredientChoice(), getPrimaryIngredientChoice(), getSecondaryIngredientChoice());
        } else {
            ...
            bukkitRecipe = new SmithingTransformRecipe(getNamespacedKey(), a.result().getItemStack(), getTemplateIngredientChoice(), getPrimaryIngredientChoice(), getSecondaryIngredientChoice());
        }
    ...
    public boolean isValid() {
        return hasIngredients() && hasResults() && !ToolsRecipeChoice.isChoiceAir(getIngredient('a'));
    }
