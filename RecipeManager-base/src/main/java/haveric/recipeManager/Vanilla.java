...
public class Vanilla {
    ...
    private static void initCompostRecipes() {
        if (Version.has1_14Support()) {
            addCompostRecipe(Material.BEETROOT_SEEDS, 0.3);
            addCompostRecipe(Material.DRIED_KELP, 0.3);
            addCompostRecipe(Material.GRASS, 0.3);
            addCompostRecipe(Material.KELP, 0.3);
            addCompostRecipe(Material.ACACIA_LEAVES, 0.3);
            addCompostRecipe(Material.BIRCH_LEAVES, 0.3);
            addCompostRecipe(Material.DARK_OAK_LEAVES, 0.3);
            addCompostRecipe(Material.JUNGLE_LEAVES, 0.3);
            addCompostRecipe(Material.OAK_LEAVES, 0.3);
            addCompostRecipe(Material.SPRUCE_LEAVES, 0.3);
            addCompostRecipe(Material.MELON_SEEDS, 0.3);
            addCompostRecipe(Material.PUMPKIN_SEEDS, 0.3);
            addCompostRecipe(Material.ACACIA_SAPLING, 0.3);
            addCompostRecipe(Material.BIRCH_SAPLING, 0.3);
            addCompostRecipe(Material.DARK_OAK_SAPLING, 0.3);
            addCompostRecipe(Material.JUNGLE_SAPLING, 0.3);
            addCompostRecipe(Material.OAK_SAPLING, 0.3);
            addCompostRecipe(Material.SPRUCE_SAPLING, 0.3);
            addCompostRecipe(Material.SEAGRASS, 0.3);
            addCompostRecipe(Material.SWEET_BERRIES, 0.3);
            addCompostRecipe(Material.WHEAT_SEEDS, 0.3);

            addCompostRecipe(Material.CACTUS, 0.5);
            addCompostRecipe(Material.DRIED_KELP_BLOCK, 0.5);
            addCompostRecipe(Material.MELON_SLICE, 0.5);
            addCompostRecipe(Material.SUGAR_CANE, 0.5);
            addCompostRecipe(Material.TALL_GRASS, 0.5);
            addCompostRecipe(Material.VINE, 0.5);

            addCompostRecipe(Material.APPLE, 0.65);
            addCompostRecipe(Material.BEETROOT, 0.65);
            addCompostRecipe(Material.CARROT, 0.65);
            addCompostRecipe(Material.COCOA_BEANS, 0.65);
            addCompostRecipe(Material.FERN, 0.65);
            addCompostRecipe(Material.LARGE_FERN, 0.65);
            addCompostRecipe(Material.DANDELION, 0.65);
            addCompostRecipe(Material.POPPY, 0.65);
            addCompostRecipe(Material.BLUE_ORCHID, 0.65);
            addCompostRecipe(Material.ALLIUM, 0.65);
            addCompostRecipe(Material.AZURE_BLUET, 0.65);
            addCompostRecipe(Material.RED_TULIP, 0.65);
            addCompostRecipe(Material.ORANGE_TULIP, 0.65);
            addCompostRecipe(Material.WHITE_TULIP, 0.65);
            addCompostRecipe(Material.PINK_TULIP, 0.65);
            addCompostRecipe(Material.OXEYE_DAISY, 0.65);
            addCompostRecipe(Material.CORNFLOWER, 0.65);
            addCompostRecipe(Material.LILY_OF_THE_VALLEY, 0.65);
            addCompostRecipe(Material.WITHER_ROSE, 0.65);
            addCompostRecipe(Material.SUNFLOWER, 0.65);
            addCompostRecipe(Material.LILAC, 0.65);
            addCompostRecipe(Material.ROSE_BUSH, 0.65);
            addCompostRecipe(Material.PEONY, 0.65);
            addCompostRecipe(Material.LILY_PAD, 0.65);
            addCompostRecipe(Material.MELON, 0.65);
            addCompostRecipe(Material.BROWN_MUSHROOM, 0.65);
            addCompostRecipe(Material.RED_MUSHROOM, 0.65);
            addCompostRecipe(Material.MUSHROOM_STEM, 0.65);
            addCompostRecipe(Material.POTATO, 0.65);
            addCompostRecipe(Material.PUMPKIN, 0.65);
            addCompostRecipe(Material.CARVED_PUMPKIN, 0.65);
            addCompostRecipe(Material.SEA_PICKLE, 0.65);
            addCompostRecipe(Material.WHEAT, 0.65);

            addCompostRecipe(Material.BAKED_POTATO, 0.85);
            addCompostRecipe(Material.BREAD, 0.85);
            addCompostRecipe(Material.COOKIE, 0.85);
            addCompostRecipe(Material.HAY_BLOCK, 0.85);
            addCompostRecipe(Material.BROWN_MUSHROOM_BLOCK, 0.85);
            addCompostRecipe(Material.RED_MUSHROOM_BLOCK, 0.85);
    ...
    private static void addCompostRecipe(Material ingredient, double chance) {
        CompostRecipe recipe = new CompostRecipe(ingredient, Material.BONE_MEAL, chance);
