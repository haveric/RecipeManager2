...
public class FlagIngredientCondition extends Flag {
    ...
    static {
        ...
        D = new String[] { "Adds conditions for individual ingredients like ranged data values, enchantments or using stacks.",
                           ...
                           "",
                           "  nometa or !meta",
                           "    Ingredient must have no metadata (enchants, name, lore)",
                           "    Overrides enchant, name, and lore conditions if set",
                           "",
                           // TODO mark
