...
import digi.recipeManager.api.RecipeManagerCraftEvent;
import digi.recipeManager.api.RecipeManagerPrepareCraftEvent;
import digi.recipeManager.data.BlockFurnaceData;
    ...
    */
    ...
    public void eventPrepareCraft(PrepareItemCraftEvent event)
    {
        try
        {
            ...
            WorkbenchRecipe recipe = RecipeManager.getRecipes().getWorkbenchRecipe(bukkitRecipe, recipeResult);
    ...
    private void prepareRepairRecipe(Player player, CraftingInventory inventory, Location location) throws Exception
    {
        ...
        if(RecipeManager.getSettings().SPECIAL_REPAIR_ENCHANTED)
        {
