...
//    private final String        FILE_VERSION    = "version";
    ...
    public static final String  FILE_INFOITEMS  = "info - items and enchants.txt";
    ...
    private void fileItemData(boolean overwrite)
    {
        ...
        StringBuilder buffer = new StringBuilder("List of item and enchantment names.");
        ...
        buffer.append(NL);
        buffer.append(NL).append("If you prefer links, here you go:");
        buffer.append(NL).append("Item names: http://jd.bukkit.org/apidocs/org/bukkit/Material.html");
        buffer.append(NL).append("Data values: http://www.minecraftwiki.net/wiki/Data_value#Data");
        buffer.append(NL).append("Enchantments: http://jd.bukkit.org/apidocs/org/bukkit/enchantments/Enchantment.html");
        buffer.append(NL);
        buffer.append(NL);
