...
public class ItemIngredient extends ItemStack {
    /**
     * This method is the same as equals, but does not consider stack size (amount).<br> This also does not consider data value if this stack's data value is the wildcard value.<br> Use
     * {@link Vanilla#DATA_WILDCARD} if you need to know that wildcard data value.
     * 
     * @param stack
