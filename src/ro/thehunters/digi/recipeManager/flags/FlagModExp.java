...
public class FlagModExp extends Flag {
    ...
    static {
        ...
        E = new String[] { "{flag} 25 // gives 25 experience to crafter", "{flag} +25 // exacly the same as above", "{flag} -50 | <red>You lost {amount} exp!  // takes at most 50 experience from crafter, if he does not have that amount it will be set to 0.", "{flag} = 0 | <red>You lost all your experience!  // sets crafter experience to 0, that space is valid there too.", };
    }
